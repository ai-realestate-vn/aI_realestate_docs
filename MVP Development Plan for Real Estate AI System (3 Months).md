...
- **Công nghệ**: next, JSX, Tailwind CSS, WebSocket (chatbot)
- **Chức năng**:
...
- **Công nghệ**: NestJS, GoLang và Python/FastAPI, WebSocket, NLP (spaCy/Hugging Face).
- **Chức năng**:
...
- **Công nghệ**: MongoDB, Progress (lịch sử chat, nhật ký, dữ liệu cấu trúc: BĐS, lịch hẹn, người dùng), Redis (cache), QDrant.
